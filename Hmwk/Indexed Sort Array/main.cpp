 ...
 * Purpose : Create a utility of a structure
 * 			 referenced to a database sort.
 * Homework: Convert structure notation to
 * 			 the (.) operator and the array
 * 			 notation to pointer notation.
 */
